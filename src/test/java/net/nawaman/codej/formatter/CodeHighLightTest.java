...
class CodeHighLightTest {
    ...
    void testValidConstruction() {
        CodeHighLight highlight = new CodeHighLight(0, 5, 0xFFFFFF);
    ...
    void testEndOffset(int startOffset, int endOffset, int expectedEndOffset) {
        CodeHighLight highlight = new CodeHighLight(startOffset, endOffset, 0xFFFFFF);
        assertEquals(expectedEndOffset, highlight.endOffset());
    }
    
    @Test
    void testColor() {
        CodeHighLight highlight = new CodeHighLight(0, 5, 0xABCDEF);
        assertEquals(0xABCDEF, highlight.color());
    }
    
    @Test
    void testEqualityAndHashCode() {
        CodeHighLight highlight1 = new CodeHighLight(0, 5, 0xFFFFFF);
        CodeHighLight highlight2 = new CodeHighLight(0, 5, 0xFFFFFF);
        CodeHighLight highlight3 = new CodeHighLight(0, 6, 0xFFFFFF);
